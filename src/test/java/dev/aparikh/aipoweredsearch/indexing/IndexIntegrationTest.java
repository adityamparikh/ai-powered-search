...
class IndexIntegrationTest {
    ...
    @Test
    void shouldIndexDocumentWithAutoGeneratedId() throws Exception {
        ...
        assertThat(documentIds.get(0)).isNotEmpty();

        // Verify document was indexed
        String generatedId = documentIds.get(0);
        await().untilAsserted(() -> {
    ...
    @Test
    void shouldIndexDocumentWithMetadata() throws Exception {
        // Given
    ...
    @Test
    void shouldBatchIndexWithMixedAutoAndManualIds() throws Exception {
    ...
    @Test
    void shouldHandleEmptyBatchRequest() throws Exception {
        // Given - empty batch
    ...
    @Test
    void shouldIndexDocumentWithEmptyMetadata() throws Exception {
        // Given
        IndexRequest request = new IndexRequest(
                "doc-empty-metadata",
    ...
    @Test
    void shouldIndexDocumentWithNullMetadata() throws Exception {
        // Given
        IndexRequest request = new IndexRequest(
                "doc-null-metadata",
    ...
    @Test
    void shouldIndexLargeDocument() throws Exception {
    ...
    @Test
    void shouldIndexDocumentsWithUnicodeContent() throws Exception {
    ...
    @Test
    void shouldUpdateExistingDocument() throws Exception {
    ...
    @Test
    void shouldIndexDocumentsWithComplexMetadata() throws Exception {
